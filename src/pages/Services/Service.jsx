  ...
  return (
    <motion.div
      ...
      <motion.div
        ...
        <div className="border-b-4 border-b-amber-400 pb-2 text-center">What we offer</div>
      </motion.div>
      <motion.div
        whileInView={{ opacity: [0, 1] }}
        transition={{ duration: 2, }}
        className="flex items-center justify-center mt-5 text-3xl">
        <span className=" text-4xl font-extrabold ml-3 text-center">Our Best Servies</span>
      </motion.div>
      <br />
      <br />
      <motion.div
