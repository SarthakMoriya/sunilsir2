        ...
        <div className="lg:flex lg:items-start lg:gap-8">
          ...
          <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
            ...
            >
              <form className="w-full">
                ...
                <div className="border border-gray-100 p-2 focus-within:ring sm:flex sm:items-center sm:gap-4">
                  ...
                  <button className="mt-1 w-full bg-amber-500 px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none hover:bg-amber-600 sm:mt-0 sm:w-auto sm:shrink-0">
                    Sign Up
                  </button>
                </div>
              </form>
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <ul className="mt-6 space-y-4 text-sm">
                ...
                >
                  <Link
                    to="/"
                    className="text-gray-800 transition hover:text-amber-400"
                  >
                    Study in Canada
                  </Link>
                </li>
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <ul className="mt-6 space-y-4 text-sm">
                ...
                >
                  <Link
                    to="/"
                    className="text-gray-700 transition hover:text-amber-400"
                  >
                    Migration VIsa
                  </Link>
                </li>
            ...
            {/* <div className="col-span-2 sm:col-span-1">
              ...
              <ul className="mt-6 space-y-4 text-sm">
                <li>
                  <Link to='/' className="text-gray-700 transition hover:text-amber-400">
                    Marketing Calendar
                  </Link>
                </li>
            ...
            <ul className="col-span-2 flex justify-start gap-6 lg:col-span-5 lg:justify-end">
              ...
              >
                <a
                  href="https://www.facebook.com/iimcchdfb"
                  rel="noreferrer"
                  target="_blank"
              ...
              >
                <a
                  href="https://www.instagram.com/iimcchd/"
                  rel="noreferrer"
                  target="_blank"
                  className="text-gray-700 transition hover:opacity-75"
                >
