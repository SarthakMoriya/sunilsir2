            ...
            <div class="col-span-2 lg:col-span-3 lg:flex lg:items-end">
              <form class="w-full">
                ...
                <div class="border border-gray-100 p-2 focus-within:ring sm:flex sm:items-center sm:gap-4">
                  ...
                  <button class="mt-1 w-full bg-amber-500 px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none hover:bg-amber-600 sm:mt-0 sm:w-auto sm:shrink-0">
                    Sign Up
                  </button>
                </div>
              </form>
